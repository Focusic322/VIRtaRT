...
import GroupPhoto from "../assets/imges/GroupPhoto.jpg";
  ...
  return (
    <div className='pt-14 flex items-center max-lg:grid'>
        <div className='pr-14 pl-14  max-sm:pl-7 max-sm:pr-7'>
            ...
            <div className='pb-4'><Button title="Більше про нас"/></div>
        </div>
        <div>
            <img src={GroupPhoto} alt="Групове фото" className='w-[3200px] rounded-2xl '/>
        </div>
    </div>
  )
}
